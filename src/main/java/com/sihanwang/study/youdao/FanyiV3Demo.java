package com.sihanwang.study.youdao;
...
public class FanyiV3Demo {
    ...
    private static final String APP_KEY = "41f3cfa3ef6ede36";

    private static final String APP_SECRET = "k5etDxlOm608Uks4XCETFh1VWN0fCLsj";
    ...
    */
    private static void byte2File(byte[] result, String file) {
        File audioFile = new File("/Users/jing.wang/github/Spelling/voice", file);
